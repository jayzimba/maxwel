...
if (isset($_POST["submit"]) && $_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["employeeImage"])) {
  $name = $_POST["name"];
  $nrc = $_POST["nrc"];
  ...
  $targetDirectory = "employeeImages/";
  // $targetFile = $targetDirectory . basename($_FILES["employeeImage"]["name"]);
  $uploadOk = 1;
  $originalFileName = basename($_FILES["employeeImage"]["name"]);
  ...
  if (move_uploaded_file($_FILES["employeeImage"]["tmp_name"], $targetFile)) {
    $insert = "INSERT INTO `employees`(`name`, `nrc`, `contact`, `zone`, `image`,`pay`) VALUES('$name', '$nrc', '$contact', '$zone', '$newFileName', '$pay')";
        ...
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            <div class="col">
              ...
              <h2 class="page-title">Premises Employee Control Center</h2>
            </div>
            <!-- Page title actions -->
                  ...
                  <div class="card card-sm">
                    <div class="card-body">
                      <div class="row align-items-center">
                        ...
                        <div class="col">
                          <div class="font-weight-medium">12</div>
                  ...
                  <div class="card card-sm">
                    <div class="card-body">
                      <div class="row align-items-center">
                        ...
                        <div class="col">
                          <div class="font-weight-medium">8</div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-selectgroup-boxes row mb-3">
              <div class="col-lg-6">
                <div class="mb-3">
                  <label class="nrc">Enter NRC</label>
                  <input type="text" name="nrc" id="nrc" class="form-control" data-mask="000000/00/0" data-mask-visible="true" placeholder="00/00/0000" autocomplete="off" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="mb-3">
                  <label class="pay">Pay per Hours</label>
                  <div class="input-group input-group-flat">
                    <input type="number" class="form-control ps-0" name="pay" id="pay" />
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
