...
$getAll = "SELECT * FROM point";


if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit"])) {
        $zone = $_POST["zone"];
        $point_1_lat = $_POST["point_1_lat"];
        $point_1_long = $_POST["point_1_long"];
        $point_2_lat = $_POST["point_2_lat"];
        $point_2_long = $_POST["point_2_long"];
        $point_3_lat = $_POST["point_3_lat"];
        $point_3_long = $_POST["point_3_long"];
        $point_4_lat = $_POST["point_4_lat"];
        $point_4_long = $_POST["point_4_long"];


        $insert = "INSERT INTO `point`(`latitude1`, `longitude1`, `latitude2`, `longitude2`, `latitude3`, `longitude3`, `latitude4`, `longitude4`, `zone`) VALUES 
                        ('$point_1_lat','$point_1_long','$point_2_lat','$point_2_long','$point_3_lat', '$point_3_long','$point_4_lat','$point_4_long','$zone');
                    ";
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">ADD ZONE BOUNDS</h3>
                                </div>
                                <div class="card-body border-bottom py-3">
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            <label class="form-label">Select Zone</label>
                                            <select type="text" name="zone" class="form-select" id="zone" value="">
                                    ...
                                    <div class="card-footer">
                                        <div class="row ">
                                            <div class="col-6">
                                                ...
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="point_1_lat" placeholder="Input placeholder">
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">long</label>
                                                    <input type="text" class="form-control" name="point_1_long" placeholder="Input placeholder">
                                                </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">lat</label>
                                                    <input type="text" class="form-control" name="point_2_lat" placeholder="Input placeholder">
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">long</label>
                                                    <input type="text" class="form-control" name="point_2_long" placeholder="Input placeholder">
                                                </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-6">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">lat</label>
                                                    <input type="text" class="form-control" name="point_3_lat" placeholder="Input placeholder">
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">long</label>
                                                    <input type="text" class="form-control" name="point_3_long" placeholder="Input placeholder">
                                                </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">lat</label>
                                                    <input type="text" class="form-control" name="point_4_lat" placeholder="Input placeholder">
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <label class="form-label">long</label>
                                                    <input type="text" class="form-control" name="point_4_long" placeholder="Input placeholder">
                                                </div>
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-4">
                                                <input type="submit" value="add-coords" name="submit" class="btn btn-primary">
                                            </div>
                                            ...
                                            if ($result = mysqli_query($conn, $getAll)) {
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        echo " <tr>";
                                                        echo "<td><span class='text-muted'>ZONE " . $row['zone'] . "</span></td>";

                                                        echo "<td>" . $row['latitude1'] . ", " . $row['longitude1'] . "</td>";

                                                        echo "<td>" . $row['latitude2'] . ", " . $row['longitude2'] . "</td>";

                                                        echo "<td>" . $row['latitude3'] . ", " . $row['longitude3'] . "</td>";

                                                        echo "<td>" . $row['latitude4'] . ", " . $row['longitude4'] . "</td>";
                                                        echo "</td>";
                                                    }
                                                    echo "</table>";
                                                    // Free result set
                                                ...
                                                echo "ERROR: Could not able to execute $getAll. " . mysqli_error($conn);
                                            }
