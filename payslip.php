        ...
        <div class="container-xl">
          <div class="card card-lg">
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  <p class="h3">Maxwell Construction Company</p>
                  <address>
                    Kalewa Rd, Jambodrive<br />
                    Copperbelt, Ndola<br />
                    Zone 3, 10101<br />
                    maxwellcontructors@mc_infor.com
                  </address>
                </div>

                <div class="col-12 my-5">
                  <h1>PaySlip PS/001/15</h1>
                </div>
              </div>
              <table class="table table-transparent table-responsive">
                ...
                <tr>
                  ...
                  <td>
                    <p class="strong mb-1">Week 1</p>
                    <div class="text-muted">Zone 3</div>
                  </td>
                  <td class="text-center">67</td>
                  <td class="text-end">K75</td>
                  <td class="text-end">K2500</td>
                </tr>

                <tr>
                  <td class="text-center">2</td>
                  <td>
                    <p class="strong mb-1">Week 2</p>
                    <div class="text-muted">Zone 5</div>
                  </td>
                  <td class="text-center">87</td>
                  <td class="text-end">K75</td>
                  <td class="text-end">K3500</td>
                </tr>


                <tr>
                  <td colspan="4" class="strong text-end">Subtotal</td>
                  <td class="text-end">K6000</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="text-end">K600</td>
                </tr>
                <tr>
                  <td colspan="4" class="font-weight-bold text-uppercase text-end">
                    Total Due
                  </td>
                  <td class="font-weight-bold text-end">K5400</td>
                </tr>
              </table>
